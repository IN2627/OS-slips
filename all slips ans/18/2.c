// *************************************************************************
// ***************
// Write a C program to simulate FCFS CPU-scheduling. The arrival time and
//  first CPU-burst of different jobs should be input to the system. Accept
// no. of
//  Processes, arrival time and burst time. The output should give Gantt
// chart,
// Downloaded by Altaf Mulla (altafmulla821993@gmail.com)
// lOMoARcPSD|33819071
